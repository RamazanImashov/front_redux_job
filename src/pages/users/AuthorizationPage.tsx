...
import AuthorizationForm from "../../components/users/AuthorizationForm";
import "./login.css";
    ...
    <div className="star-body">
      ...
      <section className="star-wars">
          ...
          <div className="at-at-content">
            <div className="at-at-body">
              ...
              <div className="at-at-body-bottom">
                <div className="at-at-body-bottom-bg">
                  <i></i>
                  <i></i>
                  <i></i>
                </div>
          ...
          <div className="leg-content leg-front">
            ...
            <div className="leg-first">
              ...
              <div className="in-first-leg">
                <div className="leg-second-joint">
                  <i></i>
                </div>
                <div className="leg-second">
                  <i className="leg-second-hr"></i>
                  <div className="in-second-leg">
                    <div className="foot-joint">
                      <i className="foot-ankle">
                        <i className="foot-ankle-bg"></i>
                      </i>
                    </div>
        ...
        <div className="space-ship space-ship-small">
          ...
          <i className="space-ship-bg">
            <i className="space-ship-gun"></i>
          </i>
        </div>
